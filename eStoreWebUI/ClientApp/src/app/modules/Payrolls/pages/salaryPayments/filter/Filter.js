...
export function SalaryPaymentsFilter({ listLoading }) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(salaryPaymentsUIProps.queryParams, values);
    if (!isEqual(newQueryParams, salaryPaymentsUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      salaryPaymentsUIProps.setQueryParams(newQueryParams);
    }
  };
