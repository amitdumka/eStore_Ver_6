...
export function TranscationModesFilter({ listLoading }) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(transcationModesUIProps.queryParams, values);
    if (!isEqual(newQueryParams, transcationModesUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      transcationModesUIProps.setQueryParams(newQueryParams);
    }
  };
