...
export function CashReceiptsFilter({ listLoading }) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(cashReceiptsUIProps.queryParams, values);
    if (!isEqual(newQueryParams, cashReceiptsUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      cashReceiptsUIProps.setQueryParams(newQueryParams);
    }
  };
