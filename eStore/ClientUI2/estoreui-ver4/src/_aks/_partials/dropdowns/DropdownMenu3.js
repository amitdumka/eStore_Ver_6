...
export function DropdownEmpMenu() {
    return <>
        {/*begin::Naviigation*/}
        <ul className="navi">
            <li className="navi-header font-weight-bold py-5">
                <span className="font-size-lg">Add Record: </span>
            ...
            <li className="navi-item">
                <a href="/payroll/employee/attendances/new" className="navi-link">
                    <span className="navi-icon"><i className="flaticon2-shopping-cart-1"></i></span>
                    <span className="navi-text">Add Attendance</span>
                </a>
            </li>
            <li className="navi-item">
                <a href="/payroll/employee/employees/new" className="navi-link">
                    <span className="navi-icon"><i className="navi-icon flaticon2-calendar-8"></i></span>
                    <span className="navi-text">Add Employee</span>
