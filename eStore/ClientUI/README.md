...
1. `package.json`
   ...
   ```diff
   -  "homepage": "https://aklabs.in/matUI/demo/react",
   +  "homepage": "https://youdomain.io/your/apps",
       "scripts": {
   -     "serve": "cp-cli build _site/matUI/demo/react && serve",
   +     "serve": "cp-cli build _site/yout/app && serve",
   ```
...
2. `serve.json`
   ...
   ```diff
      ...
      "redirects": [
        {
          "source": "/",
   -      "destination": "/akslab/matUi/react"
   +      "destination": "/my/app"
        }
      ],
      "rewrites": [
        {
   -      "source": "/akslab/matUI/react/**",
   +      "source": "/my/app/**",
   -      "destination": "/akslab/react/index.html"
