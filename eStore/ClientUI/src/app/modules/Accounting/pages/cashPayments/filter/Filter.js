...
export function CashPaymentsFilter({ listLoading }) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(cashPaymentsUIProps.queryParams, values);
    if (!isEqual(newQueryParams, cashPaymentsUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      cashPaymentsUIProps.setQueryParams(newQueryParams);
    }
  };
