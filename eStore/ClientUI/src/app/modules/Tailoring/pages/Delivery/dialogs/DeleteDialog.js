...
export function DeleteDialog({ id, show, onHide }) {
  ...
  const deleteDelivery = () => {
    // server request for deleting delivery by id
    dispatch(actions.deleteDelivery(id)).then(() => {
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        {!isLoading && (
          <span>Are you sure to permanently delete this delivery?</span>
        )}
        {isLoading && <span>Delivery is deleting...</span>}
      </Modal.Body>
      <Modal.Footer>
        <div>
          <button
