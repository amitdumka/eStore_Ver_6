      ...
      <div className={`card card-custom ${className}`}>
        ...
        <div className="card-header border-0 py-5">
          <h3 className="card-title align-items-start flex-column">
            <span className="card-label font-weight-bolder text-dark">Notice Board</span>
            <span className="text-muted mt-3 font-weight-bold font-size-sm">Latest News</span>
          </h3>
          <div className="card-toolbar">
            <a href="#" className="btn btn-info font-weight-bolder font-size-sm mr-3">New Notice</a>
            <a href="#" className="btn btn-danger font-weight-bolder font-size-sm">News</a>
          </div>
        </div>
        {/* Body */}
            ...
            <div className="table-responsive">
              <table className="table table-head-custom table-head-bg table-borderless table-vertical-center">
                ...
                <tr className="text-left text-uppercase">
                  <th className="pl-7" style={{minWidth: "250px"}}><span className="text-dark-75">Information</span></th>
